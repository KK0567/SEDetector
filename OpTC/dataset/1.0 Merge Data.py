...
if __name__ == "__main__":
    merge_json_stream(
        json1=r"../Result/0.0数据提取/AIA-151-175.ecar-2019-12-08T16-55-16.971.json",
        json2=r"../Result/0.0数据提取/AIA-151-175.ecar-last.json",
        out_json=r"../Result/1.0数据合并/AIA-151-175_merged.json",
    )
