...
if __name__ == "__main__":
    ...
    ap.add_argument("--in", dest="inp", default="../Result_Log/2.Behavior_Slices/fivedirections-3/raw_log_slices_labeled_3.json")
    ap.add_argument("--out_jsonl", default="../Result_Log/3.semantic_mapping/fivedirections-3/Behavioral_Evidence_Package_3.json")
    ap.add_argument("--out_txt", default="../Result_Log/3.semantic_mapping/fivedirections-3/Behavioral_Evidence_Package_3.txt")
