...
# ================= 配置区域 =================
INPUT_DIR = '../DATA'                 # 这里存放解压后的文件夹（里面包含 .gz 文件）
OUTPUT_DIR = '../Result_Log/1.Data_json/fivedirections-2'  # 输出 json 的目录
EXTRACT_DATUM = True                 # Avro record 若包含 datum 字段则抽取 datum
FILTER_KEYWORD = 'fivedirections-2'            # 只处理包含此关键词的文件/路径；None 则处理所有 .gz
