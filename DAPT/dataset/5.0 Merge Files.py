...
if __name__ == "__main__":
    ...
    ap.add_argument("--in_dir", default="../4.0行为语义证据包", help="folder containing *.jsonl evidence packs")
    ap.add_argument("--out", default="../4.0行为语义证据包/enp0s3-week-merge.jsonl", help="merged output jsonl path")
