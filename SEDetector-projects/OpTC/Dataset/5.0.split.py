...
def main():
    ...
    # 需要分别运行0160/0165/0170，三个数据的数据集划分
    ap.add_argument("--input", default="../Result/4.Evidence_package/host_0170.json", help="Input slices file (may be concatenated json)")
    ap.add_argument("--out_dir", default="../Result/5.split/0170", help="Output directory")
