...
def main():
    ...
    ap.add_argument("--input", default="../Result_Log/3.semantic_mapping/fivedirections-1/Behavioral_Evidence_Package_1.json", help="Input slices file (may be concatenated json)")
    ap.add_argument("--out_dir", default="../Result_YiChang/4.1.division_time/fivedirections-1", help="Output directory")
