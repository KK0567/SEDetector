...
def main():
    ...
    parser.add_argument("--f1", default="../Result/5.split/0160/train.jsonl", help="first jsonl file")
    parser.add_argument("--f2", default="../Result/5.split/0165/train.jsonl", help="second jsonl file")
    parser.add_argument("--f3", default="../Result/5.split/0170/train.jsonl", help="third jsonl file")
    parser.add_argument("--out", default="../Result/6.Merge_all/train_all.jsonl", help="output jsonl file")
