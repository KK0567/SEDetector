...
def main():
    ...
    parser.add_argument("--f1", default="../Result/5.0数据集划分/0160/test.jsonl", help="first jsonl file")
    parser.add_argument("--f2", default="../Result/5.0数据集划分/0165/test.jsonl", help="second jsonl file")
    parser.add_argument("--f3", default="../Result/5.0数据集划分/0170/test.jsonl", help="third jsonl file")
    parser.add_argument("--out", default="../Result/5.0数据集划分/test_all.jsonl", help="output jsonl file")
