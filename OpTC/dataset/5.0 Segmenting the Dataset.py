...
def main():
    ...
    ap.add_argument("--input", default="../Result/4.0行为证据包/host_0165.json", help="Input slices file (may be concatenated json)")
    ap.add_argument("--out_dir", default="../Result/5.0数据集划分/0165", help="Output directory")
