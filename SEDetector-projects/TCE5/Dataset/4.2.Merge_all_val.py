...
def main():
    ...
    parser.add_argument("--f1", default="../Result_YiChang/4.1.division_time/fivedirections-1/val.jsonl", help="first jsonl file")
    parser.add_argument("--f2", default="../Result_YiChang/4.1.division_time/fivedirections-2/val.jsonl", help="second jsonl file")
    parser.add_argument("--f3", default="../Result_YiChang/4.1.division_time/fivedirections-3/val.jsonl", help="third jsonl file")
    parser.add_argument("--out", default="../Result_YiChang/4.2.Merged_all/val.jsonl", help="output jsonl file")
