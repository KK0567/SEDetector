...
EDGE_JSONL = r"../Result/1.Data_json/enp0s3-public-wednesday.jsonl"
PVT_JSONL  = r"../Result/1.Data_json/enp0s3-pvt-wednesday.jsonl"
OUT_JSONL  = r"../Result/2.Data_merge/enp0s3-wednesday-merge.jsonl"
