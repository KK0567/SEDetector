...
if __name__ == "__main__":
    ...
    ap.add_argument("--in", dest="inp", default="../3.0Behavior_Slices_new/enp0s3-thursday-merge.jsonl", help="input traffic slice jsonl (one slice per line)")
    ap.add_argument("--out", dest="outp", default="../4.0行为语义证据包/enp0s3-thursday-merge.jsonl", help="output semantic pack jsonl")
