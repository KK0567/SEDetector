...
if __name__ == "__main__":
    ...
    ap.add_argument("--in", dest="inp", default="../Result/3.Slice/host_0170.json")
    ap.add_argument("--out_jsonl", default="../Result/4.Evidence_package/host_0170.json")
    ap.add_argument("--out_txt", default="../Result/4.Evidence_package/host_0170.txt")
