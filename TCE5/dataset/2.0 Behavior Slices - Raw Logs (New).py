...
if __name__ == "__main__":
    ...
    ap.add_argument("--in", dest="inp", default="../Result/1.Data_json/fivedirections-3/ta1-fivedirections-3-e5-official-1.bin.2.json", help="input JSON file (top-level array)")
    ap.add_argument("--out", dest="outp", default="../数据处理_日志/fivedirections-3/2.Behavior_Slices/raw_log_slices_labeled2（时间窗新）.json", help="output JSONL path")
