...
if __name__ == "__main__":
    ...
    ap.add_argument("--in", dest="in_jsonl", default="../Result/2.Data_merge/enp0s3-wednesday-merge.jsonl", help="input packet-level jsonl")
    ap.add_argument("--out", dest="out_jsonl", default="../Result/3.Behavior_Slices/enp0s3-wednesday-merge.jsonl", help="output slice jsonl")
